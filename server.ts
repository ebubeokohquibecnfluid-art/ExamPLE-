...
async function startServer() {
  ...
  // --- FIX 2: Add Root Route for Health Checks ---
  app.get("/", (req, res) => {
    res.send("ExamPLE API is running 🚀");
  });
  ...
  // --- FIX 4: Move app.listen to the VERY END ---
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`🚀 ExamPLE fully running on port ${PORT}`);
  });
}
